...
const ocrGcseLitTexts = {
  ...
  description: 'Complete preparation for OCR GCSE English Literature. Learn how to tackle the unique comparative extract question on Component 01, master modern and 19th-century text essays, and develop confident Shakespeare responses across extract and discursive formats.',
  color: '#7c3aed',
  moduleList: [
    {
      id: 'ocr-lt-m1',
      title: 'Component 01 Part (a): Comparing Studied Text with Unseen Extract',
      duration: '40 mins',
...
<p>Component 01, Section A, Part (a) prints an extract from your studied modern text. Below it, you receive an unseen extract from a different text in the same genre. The question asks you to compare how both writers present something specific — for example, how they present conflict, isolation, power, or family relationships.</p>

<div class="text-extract">"Compare how the writers of these two extracts present ideas about control. In your answer you should consider the writers' use of language, structure and form."<div class="source">Example Part (a) question style — OCR J352 Component 01</div></div>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing about each text separately — one half on the studied text, one half on the unseen. This is NOT comparison. You must weave both texts together within each paragraph to show genuine comparative thinking.</div>`,
    ...
    {
      id: 'ocr-lt-m2',
      title: 'Component 01 Part (b): Modern Text Essay',
      duration: '35 mins',
...
<div class="text-extract">"Explore how Priestley presents ideas about responsibility in An Inspector Calls. You should refer to the context of the play in your answer."<div class="source">Example Part (b) question style — OCR J352 Component 01</div></div>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing a standalone context paragraph that reads like a history essay. Context should explain the writer's choices — e.g., "Priestley, writing in 1945 for an audience that had experienced two world wars, uses Birling's hubris to warn against repeating pre-war complacency."</div>`,
      quiz: [
        { id: 'ocr-lt-m2-q1', question: 'How does Part (b) differ from Part (a) on Component 01?', options: ['Part (b) tests a different text entirely', 'Part (b) tests the same text but on a different aspect, without a printed extract', 'Part (b) is a creative writing task', 'Part (b) tests the unseen extract only'], correct: 1, explanation: 'Part (b) tests a different theme or aspect of the SAME studied text, but unlike Part (a), no extract is provided — you must refer to the whole text from memory.' },
    ...
    {
      id: 'ocr-lt-m3',
      title: 'Component 01 Section B: 19th-Century Extract Questions',
      duration: '40 mins',
      content: `<h2>19th-Century Literature: The Extract Route (40 marks)</h2>
<p>Section B of Component 01 tests your knowledge of a <strong>19th-century prose text</strong>. OCR gives you a <strong>choice</strong>: answer an extract-based question OR a discursive (whole-text) essay. This module focuses on the <strong>extract route</strong>.</p>
...
<div class="text-extract">"Explore how Stevenson presents the theme of duality in this extract and elsewhere in the novel."<div class="source">Example extract question style — OCR J352 Component 01 Section B</div></div>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Only analysing the printed extract and ignoring the "and elsewhere in the novel" instruction. The question explicitly asks you to connect the extract to the wider text. Aim for roughly 60% extract analysis and 40% wider text discussion.</div>`,
      quiz: [
        { id: 'ocr-lt-m3-q1', question: 'How many marks is the Section B 19th-century question worth?', options: ['20 marks', '30 marks', '40 marks', '50 marks'], correct: 2, explanation: 'The Section B question is worth 40 marks — the single highest-value question on Component 01.' },
    ...
    {
      id: 'ocr-lt-m4',
      title: 'Component 01 Section B: 19th-Century Discursive Essays',
      duration: '35 mins',
...
<div class="text-extract">"'Dickens presents Scrooge's transformation as inevitable from the very beginning.' How far do you agree with this statement?"<div class="source">Example discursive question style — OCR J352 Component 01 Section B</div></div>
...
<div class="examiner-tip"><strong>Examiner Tip:</strong> You do not need to memorise full sentences. Short, impactful phrases work better: "hard and sharp as flint" (Scrooge), "secret pleasures" (Jekyll), "I am no bird" (Jane Eyre). These are easy to embed and rich in analysis potential.</div>`,
    ...
    {
      id: 'ocr-lt-m5',
      title: 'Component 02 Section B: Shakespeare',
      duration: '40 mins',
      content: `<h2>Shakespeare (40 marks)</h2>
<p>Component 02, Section B tests your knowledge of a <strong>Shakespeare play</strong>. As with the 19th-century question, OCR gives you a <strong>choice</strong> between an extract-based question and a discursive essay. Both are worth 40 marks.</p>

<div class="key-term"><strong>Key Term: Component 02</strong> — The second examined component of OCR J352. Section A covers poetry (anthology and unseen). Section B covers Shakespeare. The paper is 2 hours long.</div>
...
<div class="text-extract">"Explore how Shakespeare presents the relationship between Macbeth and Lady Macbeth in this extract and elsewhere in the play."<div class="source">Example extract question style — OCR J352 Component 02 Section B</div></div>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Treating Shakespeare as a novel rather than a play. Always remember it is a dramatic text — discuss staging, audience response, dramatic tension, and theatrical effects alongside language analysis.</div>`,
      quiz: [
        { id: 'ocr-lt-m5-q1', question: 'How many marks is the Shakespeare question worth?', options: ['20 marks', '30 marks', '40 marks', '50 marks'], correct: 2, explanation: 'The Shakespeare question on Component 02 Section B is worth 40 marks, whether you choose the extract or discursive route.' },
...
<div class="key-term"><strong>Key Term: Question choice</strong> — On Component 01 Section B (19th-century) and Component 02 Section B (Shakespeare), you choose between an extract-based question and a discursive whole-text essay. Both are worth 40 marks. You answer ONE only.</div>
...
<p>Component 01 is <strong>2 hours</strong>. Section A (modern text Parts a and b) is worth 40 marks. Section B (19th-century) is worth 40 marks. Split your time evenly:</p>
<ul>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Spending too long on Section A and rushing Section B. Both sections are worth 40 marks — they deserve equal time. Use a watch and stick to your timing plan.</div>`,
      quiz: [
        ...
        { id: 'ocr-lt-m6-q3', question: 'How long is the Component 01 exam?', options: ['1 hour', '1 hour 30 minutes', '2 hours', '2 hours 30 minutes'], correct: 2, explanation: 'Component 01 is 2 hours long, covering Section A (modern text, 40 marks) and Section B (19th-century text, 40 marks).' },
  ...
  assessmentQuestions: [
    ...
    { id: 'ocr-lt-a2', question: 'What is unique about OCR Component 01 Part (a)?', options: ['It tests poetry', 'It requires comparing a studied modern text extract with an unseen same-genre extract', 'It is a creative writing task', 'It tests two Shakespeare plays'], correct: 1, explanation: 'OCR is unique in requiring students to compare an extract from their studied modern text with an unseen extract from the same genre. No other major board does this.' },
    { id: 'ocr-lt-a3', question: 'How many marks is Component 01 worth in total?', options: ['40 marks', '60 marks', '80 marks', '100 marks'], correct: 2, explanation: 'Component 01 is worth 80 marks total: Section A (Parts a and b) worth 40 marks, and Section B (19th-century text) worth 40 marks.' },
    ...
    { id: 'ocr-lt-a9', question: 'How long is the Component 01 exam?', options: ['1 hour', '1 hour 30 minutes', '2 hours', '3 hours'], correct: 2, explanation: 'Component 01 is a 2-hour exam covering modern text (Section A, 40 marks) and 19th-century text (Section B, 40 marks).' },
    ...
    { id: 'ocr-lt-a19', question: 'What is the recommended time for Section B of Component 01?', options: ['20 minutes', '30 minutes', '40 minutes', '60 minutes'], correct: 2, explanation: '40 minutes is recommended for Section B (19th-century text), matching the 40 marks available. This leaves appropriate time for Section A.' },
