...
const QUESTIONS = [
  ...
  // === ADDITIONAL QUESTIONS (82 more to reach 365) ===
  { question: "What is 'apostrophe' as a literary device?", type: "definition", options: ["A punctuation mark", "Directly addressing an absent person or abstract idea", "A type of exclamation", "A rhetorical question"], answer: 1, explanation: "Apostrophe (the figure of speech) involves addressing someone or something absent or abstract.", topic: "Literary Techniques" },
  { question: "Who wrote 'The Rime of the Ancient Mariner'?", type: "context", options: ["William Wordsworth", "Samuel Taylor Coleridge", "Lord Byron", "John Keats"], answer: 1, explanation: "Coleridge published this famous narrative poem in 1798.", topic: "Romantic Poetry" },
  { question: "What technique: 'The wind whispered through the trees'?", type: "technique", options: ["Simile", "Onomatopoeia", "Personification", "Metaphor"], answer: 2, explanation: "The wind is given the human ability to whisper — personification.", topic: "Literary Techniques" },
  { question: "What is the correct plural of 'phenomenon'?", type: "grammar", options: ["Phenomenons", "Phenomena", "Phenomenas", "Phenomeni"], answer: 1, explanation: "'Phenomena' is the correct plural of the Greek-derived word 'phenomenon'.", topic: "Grammar" },
  { question: "What is a 'picaresque' novel?", type: "definition", options: ["A novel about pirates", "A novel following a roguish hero through episodic adventures", "A detective novel", "A pastoral novel"], answer: 1, explanation: "A picaresque novel follows a witty, roguish protagonist through a series of adventures.", topic: "Literary Forms" },
  { question: "Who wrote 'Tess of the d'Urbervilles'?", type: "context", options: ["Charles Dickens", "George Eliot", "Thomas Hardy", "Anthony Trollope"], answer: 2, explanation: "Thomas Hardy published Tess of the d'Urbervilles in 1891.", topic: "19th Century Literature" },
  { question: "What technique: 'Fair is foul, and foul is fair'?", type: "technique", options: ["Oxymoron", "Chiasmus", "Paradox", "Antithesis"], answer: 1, explanation: "The reversed word order (fair/foul then foul/fair) creates chiasmus.", topic: "Shakespeare" },
  { question: "Which is correct: 'lay' or 'lie'? 'I need to __ down.'", type: "grammar", options: ["lay", "lie", "Both are correct", "laid"], answer: 1, explanation: "'Lie' means to recline (intransitive); 'lay' means to put something down (transitive).", topic: "Commonly Confused Words" },
  { question: "What is 'dramatic monologue'?", type: "definition", options: ["A play with one character", "A poem where a speaker addresses a silent listener", "A soliloquy", "Any long speech"], answer: 1, explanation: "A dramatic monologue is a poem spoken by a fictional character to a silent audience.", topic: "Poetry" },
  { question: "What historical event inspired Wilfred Owen's poetry?", type: "context", options: ["The Boer War", "World War I", "The Industrial Revolution", "The Crimean War"], answer: 1, explanation: "Owen wrote about his experiences as a soldier in the trenches of World War I.", topic: "War Poetry" },
  { question: "What technique: 'A sea of troubles'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Hyperbole"], answer: 1, explanation: "Troubles are described AS a sea — a metaphor suggesting overwhelming quantity.", topic: "Literary Techniques" },
  { question: "What is a 'compound-complex' sentence?", type: "grammar", options: ["A sentence with one clause", "A sentence with two independent clauses and at least one dependent clause", "A very long sentence", "A sentence with semicolons"], answer: 1, explanation: "A compound-complex sentence combines compound (2+ independent clauses) and complex (1+ dependent clause) elements.", topic: "Sentence Structure" },
  { question: "What is 'gothic doubling'?", type: "definition", options: ["Two gothic novels by the same author", "Characters or settings that mirror or contrast each other", "Repeating gothic imagery", "A sequel to a gothic novel"], answer: 1, explanation: "Gothic doubling uses mirror characters or doppelgangers to explore duality.", topic: "Literary Genres" },
  { question: "Which Dickens novel features Miss Havisham?", type: "context", options: ["A Tale of Two Cities", "Oliver Twist", "Great Expectations", "Bleak House"], answer: 2, explanation: "Miss Havisham is the eccentric jilted bride in Great Expectations.", topic: "19th Century Literature" },
  { question: "What technique: 'The car coughed and spluttered to life'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Onomatopoeia"], answer: 2, explanation: "The car is given human actions (coughing, spluttering) — personification.", topic: "Literary Techniques" },
  { question: "What is the difference between 'imply' and 'infer'?", type: "grammar", options: ["They mean the same thing", "Imply = suggest; infer = deduce", "Imply = deduce; infer = suggest", "Neither is commonly used"], answer: 1, explanation: "A speaker implies (hints); a listener infers (concludes from evidence).", topic: "Commonly Confused Words" },
  { question: "What is a 'pastoral' in literature?", type: "definition", options: ["A religious text", "A work idealising rural life and nature", "A type of elegy", "A comic play"], answer: 1, explanation: "Pastoral literature romanticises the simplicity and beauty of rural life.", topic: "Literary Forms" },
  { question: "What era does 'The Canterbury Tales' belong to?", type: "context", options: ["Renaissance", "Medieval", "Enlightenment", "Victorian"], answer: 1, explanation: "Chaucer wrote The Canterbury Tales in the late 14th century Medieval period.", topic: "Literary History" },
  { question: "What technique: 'She floated into the room like a ghost'?", type: "technique", options: ["Metaphor", "Simile", "Personification", "Imagery"], answer: 1, explanation: "The word 'like' signals a simile comparing her movement to a ghost's.", topic: "Literary Techniques" },
  { question: "Which is correct: 'who' or 'that'? 'The person __ called was my mother.'", type: "grammar", options: ["who", "that", "Both are acceptable", "which"], answer: 2, explanation: "Both 'who' and 'that' can refer to people, though 'who' is often preferred.", topic: "Grammar" },
  { question: "What is 'magical realism'?", type: "definition", options: ["Fantasy literature", "Fiction blending realistic narrative with magical elements as normal", "Science fiction", "Surrealist poetry"], answer: 1, explanation: "Magical realism presents magical events as ordinary parts of everyday life.", topic: "Literary Movements" },
  { question: "Who wrote 'Dulce et Decorum Est'?", type: "context", options: ["Siegfried Sassoon", "Wilfred Owen", "Rupert Brooke", "Isaac Rosenberg"], answer: 1, explanation: "Wilfred Owen wrote this anti-war poem about a gas attack in WWI.", topic: "War Poetry" },
  { question: "What technique: 'Darkness imprisons all within its embrace'?", type: "technique", options: ["Personification and metaphor", "Simile", "Hyperbole", "Alliteration"], answer: 0, explanation: "Darkness is given human actions (imprisoning, embracing) — personification within a metaphor.", topic: "Literary Techniques" },
  { question: "What is a 'determiner' in grammar?", type: "grammar", options: ["A word that expresses action", "A word placed before a noun to clarify what it refers to", "A word that describes a verb", "A connecting word"], answer: 1, explanation: "Determiners (the, a, this, my, some) precede nouns to specify them.", topic: "Grammar" },
  { question: "What is 'naturalism' in literature?", type: "definition", options: ["Writing about nature", "An extreme form of realism showing humans shaped by environment and heredity", "Romantic idealism", "Fantasy writing"], answer: 1, explanation: "Naturalism depicts characters as products of their environment, heredity, and social conditions.", topic: "Literary Movements" },
  { question: "In which century did the novel as a form emerge in English literature?", type: "context", options: ["15th century", "16th century", "18th century", "19th century"], answer: 2, explanation: "The English novel emerged in the 18th century with works like Robinson Crusoe and Tom Jones.", topic: "Literary History" },
  { question: "What technique: 'Every breath a battle, every step a war'?", type: "technique", options: ["Simile", "Metaphor and parallelism", "Hyperbole", "Personification"], answer: 1, explanation: "Breaths and steps are metaphorically described as battles and wars in a parallel structure.", topic: "Literary Techniques" },
  { question: "What is an 'Oxford comma'?", type: "grammar", options: ["A comma used in Oxford University", "The comma before 'and' in a list of three or more", "A comma after 'however'", "A comma splice"], answer: 1, explanation: "The Oxford (or serial) comma comes before the final conjunction in a list.", topic: "Punctuation" },
  { question: "What is 'Sturm und Drang'?", type: "definition", options: ["A musical term only", "A German literary movement emphasising extreme emotion", "A type of poetry", "A dramatic technique"], answer: 1, explanation: "Sturm und Drang ('Storm and Stress') was a proto-Romantic German literary movement.", topic: "Literary Movements" },
  { question: "Who wrote 'Othello'?", type: "context", options: ["Christopher Marlowe", "William Shakespeare", "Ben Jonson", "John Webster"], answer: 1, explanation: "Shakespeare wrote Othello around 1603-1604.", topic: "Shakespeare" },
  { question: "What technique: 'Time is a thief'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Both B and C"], answer: 3, explanation: "Time is described AS a thief (metaphor) and given the human quality of stealing (personification).", topic: "Literary Techniques" },
  { question: "What is a 'comma splice'?", type: "grammar", options: ["Using too many commas", "Joining two independent clauses with only a comma", "Forgetting a comma", "Using a comma before 'and'"], answer: 1, explanation: "A comma splice incorrectly joins two independent clauses with just a comma.", topic: "Grammar" },
  { question: "What is 'defamiliarisation' in literature?", type: "definition", options: ["Making the familiar strange to see it anew", "Forgetting characters", "Using unfamiliar vocabulary", "Setting a story in a foreign land"], answer: 0, explanation: "Defamiliarisation presents ordinary things in unfamiliar ways to refresh perception.", topic: "Literary Techniques" },
  { question: "What was the 'Angry Young Men' movement?", type: "context", options: ["A Victorian protest group", "1950s British writers criticising the establishment", "American Beat poets", "Romantic revolutionaries"], answer: 1, explanation: "The Angry Young Men were 1950s British writers who challenged class and social conventions.", topic: "Literary Movements" },
  { question: "What technique: 'Blood-red sunset dripped across the horizon'?", type: "technique", options: ["Simile", "Metaphor and colour imagery", "Personification", "Pathetic fallacy"], answer: 1, explanation: "The sunset is metaphorically described as dripping blood-red — a vivid colour metaphor.", topic: "Literary Techniques" },
  { question: "What is the difference between 'which' and 'that' in clauses?", type: "grammar", options: ["They're interchangeable", "'That' defines; 'which' adds extra info", "'Which' defines; 'that' adds extra info", "Only 'that' is correct"], answer: 1, explanation: "'That' introduces restrictive (essential) clauses; 'which' introduces non-restrictive (extra info) clauses.", topic: "Grammar" },
  { question: "What is a 'Byronic hero'?", type: "definition", options: ["Any hero in Byron's poetry", "A charismatic, moody, rebellious protagonist", "A classical Greek hero", "A comic character"], answer: 1, explanation: "A Byronic hero is dark, brooding, passionate, and often morally ambiguous.", topic: "Character Types" },
  { question: "Who wrote 'Heart of Darkness'?", type: "context", options: ["Rudyard Kipling", "Joseph Conrad", "E.M. Forster", "Graham Greene"], answer: 1, explanation: "Joseph Conrad published Heart of Darkness in 1899.", topic: "19th Century Literature" },
  { question: "What technique: 'Hope is the thing with feathers'?", type: "technique", options: ["Simile", "Extended metaphor", "Personification", "Allegory"], answer: 1, explanation: "Dickinson uses an extended metaphor comparing hope to a bird throughout the poem.", topic: "Literary Techniques" },
  { question: "What is a 'malapropism'?", type: "grammar", options: ["A type of pun", "The mistaken use of a similar-sounding word", "A deliberate misspelling", "A grammatical error"], answer: 1, explanation: "A malapropism confuses a word with a similar-sounding one (e.g., 'dance a flamingo' for 'flamenco').", topic: "Language" },
  { question: "What is a 'frame narrative'?", type: "definition", options: ["A story told in picture frames", "A story within a story structure", "A first-person narrative", "A non-linear narrative"], answer: 1, explanation: "A frame narrative has an outer story that contains one or more inner stories.", topic: "Narrative Structure" },
  { question: "What period is 'Beowulf' from?", type: "context", options: ["Medieval", "Anglo-Saxon", "Renaissance", "Romantic"], answer: 1, explanation: "Beowulf is the oldest surviving long poem in Old English, from the Anglo-Saxon period.", topic: "Literary History" },
  { question: "What technique: 'The city never sleeps'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Hyperbole"], answer: 2, explanation: "The city is given the human ability to sleep (or not sleep) — personification.", topic: "Literary Techniques" },
  { question: "What is a 'predicate' in a sentence?", type: "grammar", options: ["The subject", "The part containing the verb and information about the subject", "An adjective", "A conjunction"], answer: 1, explanation: "The predicate is everything in the sentence that tells what the subject does or is.", topic: "Grammar" },
  { question: "What is 'hamartia'?", type: "definition", options: ["A type of poem", "A tragic hero's fatal flaw", "A plot device", "A narrative technique"], answer: 1, explanation: "Hamartia is the tragic flaw that leads to a hero's downfall (from Aristotle's Poetics).", topic: "Drama" },
  { question: "Which poet wrote 'Ozymandias'?", type: "context", options: ["John Keats", "Lord Byron", "Percy Bysshe Shelley", "William Wordsworth"], answer: 2, explanation: "Percy Bysshe Shelley published 'Ozymandias' in 1818.", topic: "Romantic Poetry" },
  { question: "What technique: 'The walls have ears'?", type: "technique", options: ["Personification", "Metaphor", "Idiom", "All of these"], answer: 3, explanation: "This is an idiom that personifies walls and metaphorically suggests being overheard.", topic: "Literary Techniques" },
  { question: "What is the difference between 'compliment' and 'complement'?", type: "grammar", options: ["They mean the same thing", "Compliment = praise; complement = complete", "Compliment = complete; complement = praise", "Both are spellings of the same word"], answer: 1, explanation: "A compliment is praise; a complement completes or goes well with something.", topic: "Commonly Confused Words" },
  { question: "What is 'mimesis'?", type: "definition", options: ["A type of performance", "The imitation or representation of reality in art", "A musical term", "A grammatical concept"], answer: 1, explanation: "Mimesis is the artistic imitation of the real world, as discussed by Aristotle.", topic: "Literary Analysis" },
  { question: "Who wrote 'Brave New World'?", type: "context", options: ["George Orwell", "Aldous Huxley", "Ray Bradbury", "H.G. Wells"], answer: 1, explanation: "Aldous Huxley published Brave New World in 1932.", topic: "20th Century Literature" },
  { question: "What technique: 'Life is a journey'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Allegory"], answer: 1, explanation: "Life IS a journey — a direct metaphor without 'like' or 'as'.", topic: "Literary Techniques" },
  { question: "What is a 'participle'?", type: "grammar", options: ["A type of noun", "A verb form used as an adjective", "A conjunction", "A type of pronoun"], answer: 1, explanation: "A participle is a verb form (running, broken) that can function as an adjective.", topic: "Grammar" },
  { question: "What is 'ekphrasis'?", type: "definition", options: ["A type of metaphor", "A vivid description of a visual work of art in writing", "A dramatic technique", "A form of alliteration"], answer: 1, explanation: "Ekphrasis is the literary description or commentary on a visual work of art.", topic: "Literary Techniques" },
  { question: "Who wrote 'The Picture of Dorian Gray'?", type: "context", options: ["Oscar Wilde", "Henry James", "Robert Louis Stevenson", "Bram Stoker"], answer: 0, explanation: "Oscar Wilde published The Picture of Dorian Gray in 1890.", topic: "19th Century Literature" },
  { question: "What technique: 'My soul is an enchanted boat'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Conceit"], answer: 1, explanation: "The soul IS an enchanted boat — a metaphor creating a vivid comparison.", topic: "Literary Techniques" },
  { question: "What is a 'subordinate clause'?", type: "grammar", options: ["The main clause", "A clause that cannot stand alone and depends on the main clause", "A clause with a semicolon", "An independent clause"], answer: 1, explanation: "A subordinate (dependent) clause adds information but cannot stand alone as a sentence.", topic: "Sentence Structure" },
  { question: "What is 'blank verse'?", type: "definition", options: ["Poetry without any form", "Unrhymed iambic pentameter", "Free verse", "Poetry with no metre"], answer: 1, explanation: "Blank verse uses iambic pentameter but does not rhyme.", topic: "Poetry" },
  { question: "Who wrote 'A Room of One's Own'?", type: "context", options: ["Sylvia Plath", "Virginia Woolf", "George Eliot", "Mary Shelley"], answer: 1, explanation: "Virginia Woolf published this extended essay on women and fiction in 1929.", topic: "20th Century Literature" },
  { question: "What technique: 'The news hit her like a tonne of bricks'?", type: "technique", options: ["Metaphor", "Simile", "Hyperbole", "Both B and C"], answer: 3, explanation: "This uses 'like' (simile) and exaggerates the impact (hyperbole).", topic: "Literary Techniques" },
  { question: "What is the difference between 'principal' and 'principle'?", type: "grammar", options: ["They're the same", "Principal = main/head; principle = rule/belief", "Principal = rule; principle = main", "Neither is commonly used"], answer: 1, explanation: "'Principal' means main or head of a school; 'principle' means a fundamental rule or belief.", topic: "Commonly Confused Words" },
  { question: "What is 'pathetic fallacy'?", type: "definition", options: ["A logical error", "Attributing human emotions to nature or weather", "A type of paradox", "An unreliable narrator"], answer: 1, explanation: "Pathetic fallacy gives human emotions to natural elements, often reflecting characters' feelings.", topic: "Literary Techniques" },
  { question: "Who is considered the 'father of English poetry'?", type: "context", options: ["William Shakespeare", "Geoffrey Chaucer", "John Milton", "Edmund Spenser"], answer: 1, explanation: "Geoffrey Chaucer is often called the father of English poetry for The Canterbury Tales.", topic: "Literary History" },
  { question: "What technique: 'The heart wants what it wants'?", type: "technique", options: ["Personification", "Tautology", "Metaphor", "Synecdoche and personification"], answer: 3, explanation: "The heart (synecdoche for the person) is given the ability to want (personification).", topic: "Literary Techniques" },
  { question: "What is a 'clause'?", type: "grammar", options: ["A single word", "A group of words containing a subject and verb", "A type of sentence", "A phrase without a verb"], answer: 1, explanation: "A clause is a group of words with a subject and a verb; it may or may not be a complete sentence.", topic: "Grammar" },
  { question: "What is 'hubris' in Greek tragedy?", type: "definition", options: ["The chorus", "Excessive pride that offends the gods", "A happy ending", "A subplot"], answer: 1, explanation: "Hubris is extreme arrogance that defies the natural order and typically leads to downfall.", topic: "Drama" },
  { question: "Who wrote 'Waiting for Godot'?", type: "context", options: ["Harold Pinter", "Samuel Beckett", "Tom Stoppard", "Eugene Ionesco"], answer: 1, explanation: "Samuel Beckett's absurdist play was first performed in 1953.", topic: "20th Century Drama" },
  { question: "What technique: 'Shall I compare thee to a summer's day?' as an opening?", type: "technique", options: ["Declarative statement", "Rhetorical question", "Hyperbole", "Direct address"], answer: 1, explanation: "Shakespeare opens with a rhetorical question — he doesn't expect an answer.", topic: "Shakespeare" },
  { question: "What is a 'homophone'?", type: "grammar", options: ["A word with many meanings", "Words that sound the same but differ in meaning and spelling", "Words that are spelled the same", "Words with opposite meanings"], answer: 1, explanation: "Homophones sound identical but have different meanings and often different spellings (there/their/they're).", topic: "Language" },
  { question: "What is 'metonymy'?", type: "definition", options: ["A type of metaphor", "Substituting the name of something with something closely associated", "A simile without 'like'", "A type of synecdoche"], answer: 1, explanation: "Metonymy replaces a word with something closely related (e.g., 'the Crown' for the monarchy).", topic: "Literary Techniques" },
  { question: "What decade saw the rise of postmodernist literature?", type: "context", options: ["1930s", "1950s", "1960s", "1980s"], answer: 2, explanation: "Postmodernism emerged in the 1960s, challenging modernist assumptions about meaning and truth.", topic: "Literary Movements" },
  { question: "What technique: 'O Captain! My Captain!'?", type: "technique", options: ["Simile", "Apostrophe and exclamation", "Metaphor", "Alliteration"], answer: 1, explanation: "Whitman addresses the absent Lincoln (apostrophe) with emotional exclamation.", topic: "Poetic Techniques" },
  { question: "What is 'ellipsis' used for in writing?", type: "grammar", options: ["To end a sentence", "To indicate omission, trailing off, or suspense", "To connect clauses", "To show emphasis"], answer: 1, explanation: "Ellipsis (...) shows omitted words, a pause, or trailing thoughts.", topic: "Punctuation" },
  { question: "What is 'synecdoche'?", type: "definition", options: ["A type of irony", "Using a part to represent the whole (or vice versa)", "A type of personification", "A sound device"], answer: 1, explanation: "Synecdoche uses a part to represent the whole ('all hands on deck' = all people).", topic: "Literary Techniques" },
  { question: "In which work does the line 'Et tu, Brute?' appear?", type: "context", options: ["Hamlet", "Julius Caesar", "Macbeth", "Antony and Cleopatra"], answer: 1, explanation: "Caesar speaks these words to Brutus in Shakespeare's Julius Caesar.", topic: "Shakespeare" },
  { question: "What technique: 'She had butterflies in her stomach'?", type: "technique", options: ["Simile", "Metaphor", "Idiom", "Personification"], answer: 2, explanation: "This is a common idiom meaning to feel nervous — not meant literally.", topic: "Literary Techniques" },
  { question: "What is a 'morpheme'?", type: "grammar", options: ["A type of sentence", "The smallest unit of meaning in a language", "A figure of speech", "A verb form"], answer: 1, explanation: "A morpheme is the smallest meaningful unit (e.g., 'un-' + 'help' + '-ful' = unhelpful).", topic: "Language" },
  { question: "What is 'stream of consciousness' narration?", type: "definition", options: ["Third person narration", "A continuous flow of a character's thoughts and perceptions", "Dialogue-only narration", "Chronological storytelling"], answer: 1, explanation: "Stream of consciousness captures the uninterrupted flow of thoughts, often without conventional structure.", topic: "Narrative Techniques" },
  { question: "What is the 'Theatre of the Absurd'?", type: "context", options: ["Comedy theatre", "Post-WWII drama depicting the meaninglessness of existence", "Victorian music hall", "Greek tragedy"], answer: 1, explanation: "The Theatre of the Absurd (1950s-60s) explored existential themes through illogical situations.", topic: "20th Century Drama" },
  { question: "What technique: 'The river snaked through the valley'?", type: "technique", options: ["Simile", "Metaphor", "Personification", "Imagery"], answer: 1, explanation: "The river is described as snaking — a metaphor comparing its winding path to a snake.", topic: "Literary Techniques" },
  { question: "What is the difference between 'stationary' and 'stationery'?", type: "grammar", options: ["They mean the same thing", "Stationary = not moving; stationery = writing materials", "Stationary = writing materials; stationery = not moving", "Both are archaic"], answer: 1, explanation: "'Stationary' means not moving; 'stationery' refers to paper and writing supplies.", topic: "Commonly Confused Words" },
  { question: "What is an 'elegy'?", type: "definition", options: ["A happy poem", "A poem of serious reflection, typically mourning the dead", "A narrative poem", "A comic poem"], answer: 1, explanation: "An elegy is a mournful poem, often written in honour of someone who has died.", topic: "Poetry" },
  { question: "Who wrote 'Ariel' and 'Lady Lazarus'?", type: "context", options: ["Emily Dickinson", "Sylvia Plath", "Anne Sexton", "Elizabeth Bishop"], answer: 1, explanation: "Sylvia Plath wrote these intensely personal confessional poems.", topic: "Poetry" },
];
...
function saveData(data) {
  try { localStorage.setItem(STORAGE_KEY, JSON.stringify(data)); } catch { /* QuotaExceeded */ }
}
